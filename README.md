...
An application to manage tasks and save them inside the device, with the ability to delete them and convert the status of the task to completed or to the archive.
Depending on Bloc (Cubit) as State Management.
...
<img alt="jpg" src="preview/view_5.jpg" width= "300" /> <img alt="jpg" src="preview/view_6.jpg" width= "300" />
...
<img align="left" src = "https://profile-counter.glitch.me/ToDo_App/count.svg" alt ="Loading">